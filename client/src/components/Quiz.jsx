    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            ...
            <div className="container mx-auto px-40 py-8">
                ...
                <div className="flex justify-center">
                    <h1 className="text-2xl font-bold mb-8 text-green-600">Are you a UrbaGreen Hero?</h1>
                </div>
                ...
                {resultMessage && (
                    <div className="mt-4">
                        <h2 className="text-lg font-bold">
                            Results:
                            <br />
                            <span className={totalPoints <= 50 ? 'text-green-600' : totalPoints <= 100 ? 'text-yellow-600' : 'text-red-600'} ml-2>
                                {resultMessage}
                            </span>
                        </h2>
                    </div>
