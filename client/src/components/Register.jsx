        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-50">
            <div className="w-full px-20 py-12 rounded-lg">
                ...
                <form
                    ...
                    {
                        username.length < 3 ?
                            <p className="text-red-700"> Username must be at least 3 characters</p> :
                            null
                    }
                    ...
                    {
                        email.length < 1 ?
                            <p className="text-red-700"> E-mail is required</p> :
                            null
                    }
                    ...
                    {
                        password.length < 8 ?
                            <p className="text-red-700"> Password should be at least 8 characters</p> :
                            null
                    }
                    ...
                    {
                        password.length < 8 ?
                            <p className="text-red-700"> Confirm Password should be at least 8 characters</p> :
                            null
                    }
